...
-- 개인별 총점, 평균을 검색해보자. 컬럼을 연산

SELECT R.* , NVL(KOR,0)+NVL(ENG,0)+NVL(MATH,0) 총점,FLOOR( (NVL(KOR,0)+NVL(ENG,0)+NVL(MATH,0))/3) 평균
FROM REPORT R;

-- 국어점수의 최대, 최소, 전체학생수를 검색해보자.
SELECT MAX(KOR),MIN(KOR),SUM(KOR),FLOOR(AVG(KOR)),FLOOR(AVG(NVL(KOR,0))),COUNT(KOR),COUNT(*) FROM REPORT;
SELECT MAX(KOR),MIN(KOR),SUM(KOR),FLOOR(AVG(NVL(KOR,0))),COUNT(KOR),COUNT(*) FROM REPORT;

--수학점수 최대, 최소, 학생수 
SELECT MAX(MATH),MIN(MATH),COUNT(MATH) FROM REPORT;
...
SELECT BAN, MAX(KOR),MIN(KOR),SUM(KOR),FLOOR(AVG(KOR)),COUNT(KOR)
FROM REPORT
GROUP BY BAN;
...
SELECT BAN, MAX(KOR),MIN(KOR),SUM(KOR),FLOOR(AVG(NVL(KOR,0))),COUNT(KOR)
FROM REPORT
WHERE KOR>=70
GROUP BY BAN
 HAVING AVG(KOR)>=80;
...
-----------------------------------------------
--GROUP BY 를 좀더 항상 시킨 ROLLUP, CUBE,GROUPING SETS
...
INSERT INTO MONTHLY_SALES VALUES('P01','2023-01', '롯데', 35000);
INSERT INTO MONTHLY_SALES VALUES('P01','2023-02', '롯데', 45000);


INSERT INTO MONTHLY_SALES VALUES('P02','2023-01', '삼성', 8000);
INSERT INTO MONTHLY_SALES VALUES('P02','2023-02', '삼성', 12000);
INSERT INTO MONTHLY_SALES VALUES('P02','2023-01', '삼성', 28000);
INSERT INTO MONTHLY_SALES VALUES('P02','2023-02', '삼성', 32000);

INSERT INTO MONTHLY_SALES VALUES('P03','2023-01', 'LG', 8500);
INSERT INTO MONTHLY_SALES VALUES('P03','2023-02', 'LG', 13000);
INSERT INTO MONTHLY_SALES VALUES('P03','2023-01', 'LG', 2500);
INSERT INTO MONTHLY_SALES VALUES('P03','2023-02', 'LG', 63000);
...
SELECT MONTH , GOODS_iD  , SUM(SALES_AMOUNT) 
FROM MONTHLY_SALES;
